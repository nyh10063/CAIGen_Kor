...
이 저장소에는 CAIGen(https://github.com/Yusuke196/CAIGen)을 기반으로 수정한 코드가 포함되어 있으며,  
해당 부분은 원저작물의 MIT License를 따릅니다.

이 저장소의 나머지 독자적 자료 및 추가 작성 부분은  
비상업적 연구 및 교육 목적에 한하여 사용할 수 있습니다.